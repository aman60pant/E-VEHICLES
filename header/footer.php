...
<head>
    ...
    <style>
        ...
        p.mb-2 {
            white-space: nowrap;
            /* Prevents line breaks within the element */
        }
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2" style="font-size: 12px;"><i class="fa fa-phone-alt me-3"></i>+91 9599868683, +91 9599868610</p>
                    <p class="mb-2 align-items-center" style="font-size: 12px;"><i class="fa fa-envelope me-3"></i><span>yogesh@saieshaevehicles.com</span></p>


                    <p class="mb-2"><i class="fa-solid fa-globe"></i>&nbsp;&nbsp;www.saieshaevehicles.com</p>
